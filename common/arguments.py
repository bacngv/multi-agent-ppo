...
def get_common_args():
    ...
    parser.add_argument('--mixing_hidden_dim', type=int, default=64, help='mixing hidden dim for VD')
    parser.add_argument('--gamma', type=float, default=0.99, help='the discount factor')
    parser.add_argument('--kl_coeff', type=float, default=0.01, help='the discount penalty kl loss')
    ...
    parser.add_argument('--n_steps', type=int, default=300000, help='total time steps')
